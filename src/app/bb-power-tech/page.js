...
export default function BBPowerTechPage() {
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between space-y-4 lg:space-y-0">
            ...
            <div className="flex items-center">
              <div className="flex items-center space-x-2 md:space-x-3">
                <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-blue-500 to-green-500 rounded-lg flex items-center justify-center">
                  <span className="text-white font-bold text-lg md:text-xl">B</span>
                </div>
                <div>
                  <h1 className="text-lg md:text-xl font-bold text-gray-800">POWER & TECHNOLOGY LTD.</h1>
                  <p className="text-xs md:text-sm text-gray-600">SHINE BRIGHT, SHINE FOREVER</p>
                </div>
              </div>
            </div>
      ...
      <main className="bg-gray-50 min-h-screen">
        <div className="max-w-6xl mx-auto px-4 py-8">
          <div className="flex flex-col lg:flex-row space-y-6 lg:space-y-0">
            ...
            <div className="w-full lg:w-1/4 bg-white rounded-lg p-4 lg:p-6 lg:mr-6">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                ...
                <div className="py-2 border-b border-gray-200">Power Systems</div>
                <div className="py-2 border-b border-gray-200">Technology</div>
                <div className="py-2 border-b border-gray-200">Electronics</div>
                <div className="py-2 border-b border-gray-200">Renewable Energy</div>
              </div>
            </div>
          ...
          <div className="mt-8 bg-orange-500 text-white p-4 md:p-6 rounded-lg text-center">
            ...
            <p className="text-base md:text-lg">Our power & technology e-commerce platform is currently under development</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <div>
              <div className="flex items-center space-x-2 md:space-x-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg md:text-xl font-bold">POWER & TECHNOLOGY</h3>
                  <p className="text-xs md:text-sm text-gray-400">SHINE BRIGHT, SHINE FOREVER</p>
                </div>
              </div>
