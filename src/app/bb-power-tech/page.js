          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-xl font-bold text-gray-800">POWER & TECHNOLOGY LTD.</h1>
                  <p className="text-sm text-gray-600">SHINE BRIGHT, SHINE FOREVER</p>
                </div>
              </div>
            </div>
      ...
      <main className="bg-gray-50 min-h-screen">
        <div className="max-w-6xl mx-auto px-4 py-8">
          ...
          <div className="mt-8 bg-orange-500 text-white p-6 rounded-lg text-center">
            ...
            <p className="text-lg">Our power & technology e-commerce platform is currently under development</p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold">POWER & TECHNOLOGY</h3>
                  <p className="text-sm text-gray-400">SHINE BRIGHT, SHINE FOREVER</p>
                </div>
              </div>
