        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex flex-col lg:flex-row items-center justify-between space-y-4 lg:space-y-0">
            ...
            <div className="flex items-center">
              <h1 className="text-2xl md:text-3xl font-bold text-red-600">EMIRATES LUB</h1>
            </div>
      ...
      <main className="bg-gray-50 min-h-screen">
        <div className="max-w-6xl mx-auto px-4 py-8">
          ...
          <div className="mt-8 bg-orange-500 text-white p-4 md:p-6 rounded-lg text-center">
            ...
            <p className="text-base md:text-lg">Our lubricant e-commerce platform is currently under development</p>
      ...
      <footer className="bg-gray-900 text-white py-8 md:py-12">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <div>
              <h3 className="text-xl md:text-2xl font-bold text-red-600 mb-4">EMIRATES LUB</h3>
