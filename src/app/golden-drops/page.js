        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              ...
              <h1 className="text-3xl font-bold text-gray-800">GOLDEN DROPS</h1>
            </div>
      ...
      <main className="bg-gray-50 min-h-screen">
        <div className="max-w-6xl mx-auto px-4 py-8">
          ...
          <div className="mt-8 bg-orange-500 text-white p-6 rounded-lg text-center">
            ...
            <p className="text-lg">Our food & beverage e-commerce platform is currently under development</p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-2xl font-bold">GOLDEN DROPS</h3>
              </div>
