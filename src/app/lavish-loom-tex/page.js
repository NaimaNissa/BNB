...
export default function LavishLoomTexPage() {
        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex flex-col lg:flex-row items-center justify-between space-y-4 lg:space-y-0">
            ...
            <div className="flex items-center">
              <h1 className="text-2xl md:text-3xl font-bold text-gray-800">LAVISH LOOM</h1>
            </div>
      ...
      <main className="bg-gray-50 min-h-screen">
        <div className="max-w-6xl mx-auto px-4 py-8">
          <div className="flex flex-col lg:flex-row space-y-6 lg:space-y-0">
            ...
            <div className="w-full lg:w-1/4 bg-white rounded-lg p-4 lg:p-6 lg:mr-6">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                ...
                <div className="py-2 border-b border-gray-200">Textiles</div>
                <div className="py-2 border-b border-gray-200">Fabrics</div>
                <div className="py-2 border-b border-gray-200">Garments</div>
                <div className="py-2 border-b border-gray-200">Home Textiles</div>
              </div>
            </div>
          ...
          <div className="mt-8 bg-orange-500 text-white p-4 md:p-6 rounded-lg text-center">
            ...
            <p className="text-base md:text-lg">Our textile e-commerce platform is currently under development</p>
      ...
      <footer className="bg-gray-900 text-white py-8 md:py-12">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <div>
              <h3 className="text-xl md:text-2xl font-bold text-white mb-4">LAVISH LOOM</h3>
